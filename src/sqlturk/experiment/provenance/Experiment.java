...
public class Experiment {
	 ...
	 *            args[1] the name of the
	 *            dataset (tpch or world). 
	 *            args[2] the index of the query, from
	 *            0 to 7. 
	 *            args[3] the number of top queries used for
	 *            computation. 
	...
	public static void main(String[] args) throws SQLException, IOException {
		...
		if (datasetName.equals("world")) {
			SQLTurk.run(type, datasetName, queryIndex, topN,
