...
//		tpchQuery3, tpchQuery4, tpchQuery5, tpchQuery6, tpchQuery7 };
	...
	SQLTurk34.run(type, datasetName, queryIndex, 6, worldCandidates[queryIndex], limit);
	SQLTurk34.run(type, datasetName, queryIndex, 7, worldCandidates[queryIndex], limit);
	SQLTurk34.run(type, datasetName, queryIndex, 8, worldCandidates[queryIndex], limit);
	SQLTurk34.run(type, datasetName, queryIndex, 9, worldCandidates[queryIndex], limit);
	SQLTurk34.run(type, datasetName, queryIndex, 10, worldCandidates[queryIndex], limit);
    }
}
