...
public class XEqui {
    ...
    private static ArrayList<ArrayList<String>> equiColumns = new ArrayList<ArrayList<String>>();
    ...
    public XEqui(Connection dbConn) throws SQLException {
	this.dbConn = dbConn;
    ...
    public static ArrayList<String> getEquiColumns(String column) {
	for (ArrayList<String> equiColumn: equiColumns) {
	    if (equiColumn.contains(column)) {
		return equiColumn;
	    }
	}
	return null;
